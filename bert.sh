...
rm -rf /origin_bert_output/CoLA/* 
echo "***** Remove files in folder SST-2 *****" 
rm -rf /origin_bert_output/SST-2/* 
echo "***** Remove files in folder QQP *****" 
rm -rf /origin_bert_output/QQP/* 
echo "***** Remove files in folder RTE *****" 
rm -rf /origin_bert_output/RTE/* 
echo "***** Remove files in folder MRPC *****" 
rm -rf /origin_bert_output/MRPC/* 
echo "***** Remove files in folder STS-B *****" 
rm -rf /origin_bert_output/STS-B/* 
echo "***** Remove files in folder QNLI *****" 
rm -rf /origin_bert_output/QNLI/* 
echo "***** Remove files in folder WNLI *****" 
rm -rf /origin_bert_output/WNLI/* 
echo "***** Remove files in folder MNLI-m *****" 
rm -rf /origin_bert_output/MNLI-m/* 
echo "***** Remove files in folder MNLI-mm *****" 
rm -rf /origin_bert_output/MNLI-mm/* 
echo "***** Remove files in folder AX *****" 
rm -rf /origin_bert_output/AX/* 
echo "***** Running ADV *****" 
rm -rf /origin_bert_output/ADV/* 
echo "***** Running CoLA *****" 
