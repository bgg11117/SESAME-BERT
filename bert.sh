...
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/QNLI/* 
echo "***** Remove files in folder WNLI *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/WNLI/* 
echo "***** Remove files in folder MNLI-m *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/MNLI-m/* 
echo "***** Remove files in folder MNLI-mm *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/MNLI-mm/* 
echo "***** Remove files in folder AX *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/AX/* 
echo "***** Running ADV *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/origin_bert_output/ADV/* 
...
echo "***** Running QQP *****" 
python run_classifier_bgg_test.py --task_name=qqp --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/QQP/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=3e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/QQP/ --do_lower_case=False 2>./origin_bert_output/QQP/qqp_blur_gpu.txt 
echo "***** Running RTE *****" 
python run_classifier_bgg_test.py --task_name=rte --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/RTE/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=3e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/RTE/ --do_lower_case=False 2>./origin_bert_output/RTE/rte_blur_gpu.txt 
echo "***** Running QNLI *****" 
python run_classifier_bgg_test.py --task_name=qnli --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/QNLI/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=3e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/QNLI/ --do_lower_case=False 2>./origin_bert_output/QNLI/qnli_blur_gpu.txt 
echo "***** Running WNLI *****" 
python run_classifier_bgg_test.py --task_name=wnli --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/WNLI/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/WNLI/ --do_lower_case=False 2>./origin_bert_output/WNLI/wnli_blur_gpu.txt 
echo "***** Running MNLI-m *****" 
python run_classifier_bgg_test.py --task_name=mnli-m --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/MNLI-m/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/MNLI-m/ --do_lower_case=False 2>./origin_bert_output/MNLI-m/mnlim_blur_gpu.txt 
echo "***** Running MNLI-mm *****" 
python run_classifier_bgg_test.py --task_name=mnli-mm --do_train=false --do_eval=true --do_predict=true --data_dir=./datasets/MNLI-mm/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./bert_output/MNLI-m/model.ckpt-36815 --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/MNLI-mm/ --do_lower_case=False 2>./origin_bert_output/MNLI-mm/mnlimm_blur_gpu.txt 
echo "***** Running AX *****" 
python run_classifier_bgg_test.py --task_name=ax --do_train=false --do_eval=false --do_predict=true --data_dir=./datasets/MNLI-m/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./bert_output/MNLI-m/model.ckpt-36815 --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/AX/ --do_lower_case=False 2>./origin_bert_output/AX/ax_blur_gpu.txt 
echo "***** Running ADV *****" 
python run_classifier_bgg_test.py --task_name=adv --do_train=false --do_eval=false --do_predict=true --data_dir=./datasets/MNLI-m/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config.json --init_checkpoint=./bert_output/MNLI-m/model.ckpt-36815 --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=3.0 --output_dir=./origin_bert_output/ADV/ --do_lower_case=False 2>./origin_bert_output/ADV/adv_blur_gpu.txt 
echo "***** Running MRPC *****" 
...
python create_pretraining_data.py --input_file=./datasets/sample_text.txt --output_file=./bert_output/Pretrain/tf_examples.tfrecord --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --do_lower_case=True --max_seq_length=128 --max_predictions_per_seq=20 --masked_lm_prob=0.15 --random_seed=12345 --dupe_factor=5 2>./bert_output/Pretrain/create_pretrain.txt 
python run_pretraining.py --input_file=./bert_output/Pretrain/tf_examples.tfrecord --output_dir=./bert_output/Pretrain/pretraining_output --do_train=true --do_eval=true --bert_config_file=./cased_L-12_H-768_A-12/bert_config_pos.json --max_seq_length=128 --train_batch_size=32 --max_predictions_per_seq=20 --num_train_steps=20 --num_warmup_steps=10 --learning_rate=2e-5 2>./bert_output/Pretrain/run_pretrain.txt 
python run_classifier_bgg_test.py --task_name=cola --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/CoLA/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config_pos.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=5e-5 --num_train_epochs=3.0 --warmup_proportion=0.15 --output_dir=./bert_output/CoLA/ --do_lower_case=False 2>./bert_output/CoLA/cola_blur_gpu.txt 