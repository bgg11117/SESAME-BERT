...
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/bert_output/CoLA/* 
...
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/bert_output/QQP/* 
echo "***** Remove files in folder RTE *****" 
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/bert_output/RTE/* 
...
rm -rf /workpool/pdt30764/notebooks_bgg/Cip/bert-master/bert_output/STS-B/* 
echo "***** Running CoLA *****" 
python run_classifier_bgg.py --task_name=cola --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/CoLA/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config_test.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=4.0 --warmup_proportion=0.15 --output_dir=./bert_output/CoLA/ --do_lower_case=False 2>./bert_output/CoLA/cola_blur_gpu.txt 
echo "***** Running SST-2 *****" 
...
echo "***** Running QQP *****" 
python run_classifier_bgg.py --task_name=qqp --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/QQP/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config_test.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=4.0 --output_dir=./bert_output/QQP/ --do_lower_case=False 2>./bert_output/QQP/qqp_blur_gpu.txt 
echo "***** Running RTE *****" 
python run_classifier_bgg.py --task_name=rte --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/RTE/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config_test.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=4.0 --output_dir=./bert_output/RTE/ --do_lower_case=False 2>./bert_output/RTE/rte_blur_gpu.txt 
echo "***** Running MRPC *****" 
...
echo "***** Running STS-B *****" 
python run_regressor_bgg.py --task_name=sts-b --do_train=true --do_eval=true --do_predict=true --data_dir=./datasets/STS-B/ --vocab_file=./cased_L-12_H-768_A-12/vocab.txt --bert_config_file=./cased_L-12_H-768_A-12/bert_config_test.json --init_checkpoint=./cased_L-12_H-768_A-12/bert_model.ckpt --max_seq_length=400 --train_batch_size=32 --learning_rate=2e-5 --num_train_epochs=4.0 --output_dir=./bert_output/STS-B/ --do_lower_case=False 2>./bert_output/STS-B/stsb_blur_gpu.txt 